...
const MIN_RUNTIME_BACKED_VALIDATED_REQUEST_DECORATORS = 64;
const MAX_DIRECT_SWAGGER_AUTO_SCHEMA_DECORATORS = 370;
const MAX_DOC_ONLY_INPUT_CONTRACT_DECORATORS = 243;
